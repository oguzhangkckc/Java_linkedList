 ...
 */
public class OğuzhanGökcekocaUser3 extends javax.swing.JFrame {

    OğuzhanGökcekocaMultiLinkedList player3;
    ...
    private void giveNumbersToCard() {
        ...
        OğuzhanGökcekocaNode temp = player3.head;
    ...
    public OğuzhanGökcekocaUser3(int [][]card1) {
        initComponents();
        player3 = new OğuzhanGökcekocaMultiLinkedList(0,card1);
        giveNumbersToCard();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OğuzhanGökcekocaUser3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int[][] empty= {{}};
                new OğuzhanGökcekocaUser3(empty).setVisible(true);
            }
        });
    }
