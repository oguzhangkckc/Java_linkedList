 ...
 */
public class OğuzhanGökcekocaUser1 extends javax.swing.JFrame {

    OğuzhanGökcekocaMultiLinkedList player1;
    ...
    private void giveNumbersToCard() {
        ...
        OğuzhanGökcekocaNode temp = player1.head;
    ...
    public OğuzhanGökcekocaUser1(int[][] card1) {
        initComponents();
        player1 = new OğuzhanGökcekocaMultiLinkedList(0, card1);
        giveNumbersToCard();
    }
    ...
    private void Button1_1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button1_1ActionPerformed
    }//GEN-LAST:event_Button1_1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OğuzhanGökcekocaUser1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int[][] card1 = null;
                new OğuzhanGökcekocaUser1(card1).setVisible(true);
            }
        });
    }
