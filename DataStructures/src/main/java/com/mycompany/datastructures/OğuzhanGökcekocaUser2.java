 ...
 */
public class OğuzhanGökcekocaUser2 extends javax.swing.JFrame {

    OğuzhanGökcekocaMultiLinkedList player2;
    ...
    private void giveNumbersToCard() {
        ...
        OğuzhanGökcekocaNode temp = player2.head;
    ...
    public OğuzhanGökcekocaUser2(int [][]card1) {
        initComponents();
        player2 = new OğuzhanGökcekocaMultiLinkedList(0,card1);
        giveNumbersToCard();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OğuzhanGökcekocaUser2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int[][] empty= {{}};
                new OğuzhanGökcekocaUser2(empty).setVisible(true);
            }
        });
    }
